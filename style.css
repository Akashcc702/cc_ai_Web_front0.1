...
.overlay {
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at center, transparent 20%, rgba(2,6,23,0.85) 100%);
  display: flex;
  align-items: center;
  justify-content: center;
}

/* CC-AI brand shown on splash */
.splash-brand {
...
@keyframes brandPulse {
  0%, 100% { opacity: 0.85; }
  50%       { opacity: 1; text-shadow: 0 0 60px rgba(139,92,246,1), 0 0 120px rgba(139,92,246,0.7); }
}
